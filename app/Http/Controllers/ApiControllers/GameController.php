...
class GameController extends Controller
{
  ...
  public function winner_limit(Request $request, $limit)
  {
    try {
      $periods = DB::table('periods')
        // ->orderBy('id', 'asc')
      ...
      foreach ($periods as $index_period => $period) {
        ...
        $data_winner = [
          'periode_name' => $selected_periods->name,
          'winners' => $winners
        ];

        $data[$index_period] = $data_winner;
      }
